...
contains the same number of elements as the count argument, while the values of each element will be 
...
output: array with amount of numbers as count and multiples of start
...
into the desired output.
  ...
  1. get count and start from arguments
  2. array is start + start +start, upto count
  3. return array
