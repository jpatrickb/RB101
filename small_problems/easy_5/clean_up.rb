...
input: string with alphanumeric and non-alphabetic characters


output: string with non-alphabetic replaced by space (max one space in a row)
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
Check for Problem Domain/Explicit requirements: The Problem Domain is the area of expertise or 
application that needs to be examined to solve a problem. 

Problem Domain: deleting in a specified way
...
Your Mental Model: two methods, one that takes chars from word, one that organizes into larger
string having only one space between each word
...
1. use two methods
2. first method takes a word and removes non-alphabet
  a.splits char into array 
  b. iterates through and removes non-alpha with predefined constant with loop and range
3. second method takes long string
  a. split into array, iterate run each word through first method
  b. join with space(' ')
4. end
=end
...
def clean_word(word)
  ...
  new_word = []
  array.each do |char|
   new_word << char if ('a'..'z').include?(char) 
   new_word << char if (0..9).include?(char)
  end
